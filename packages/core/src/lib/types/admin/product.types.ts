...
export const AdminProductSchema = z.looseObject({
  ...
  date_created: z.string().describe('The date the product was created, in the site\'s timezone.'),
  date_created_gmt: z.string().describe('The date the product was created, as GMT.'),
  date_modified: z.string().describe('The date the product was last modified, in the site\'s timezone.'),
  date_modified_gmt: z.string().describe('The date the product was last modified, as GMT.'),
  type: z.enum(['simple', 'grouped', 'external', 'variable']).describe('Product type.'),
  status: z.enum(['draft', 'pending', 'private', 'publish']).describe('Product status (post status).'),
  featured: z.boolean().describe('Featured product.'),
  catalog_visibility: z.enum(['visible', 'catalog', 'search', 'hidden']).describe('Catalog visibility.'),
  ...
  date_on_sale_from: z.string().nullable().describe('Start date of sale price, in the site\'s timezone.'),
  date_on_sale_from_gmt: z.string().nullable().describe('Start date of sale price, as GMT.'),
  date_on_sale_to: z.string().nullable().describe('End date of sale price, in the site\'s timezone.'),
  date_on_sale_to_gmt: z.string().nullable().describe('End date of sale price, in the site\'s timezone.'),
  ...
  downloads: z.array(AdminDownloadableFileSchema).describe('List of downloadable files.'),
  download_limit: z.number().describe('Number of times downloadable files can be downloaded after purchase.'),
  download_expiry: z.number().describe('Number of days until access to downloadable files expires.'),
  external_url: z.string().describe('Product external URL. Only for external products.'),
  button_text: z.string().describe('Product external button text. Only for external products.'),
  ...
  stock_status: z.enum(['instock', 'outofstock', 'onbackorder']).describe('Controls the stock status of the product.'),
  backorders: z.enum(['no', 'notify', 'yes']).describe('If managing stock, this controls if backorders are allowed.'),
  ...
  low_stock_amount: z.number().nullable().describe('Low Stock amount for the product.'),
  sold_individually: z.boolean().describe('Allow one item to be bought in a single order.'),
  ...
  shipping_taxable: z.boolean().describe('Shows whether or not the product shipping is taxable.'),
  ...
  cross_sell_ids: z.array(z.number()).describe('List of cross-sell products IDs.'),
  parent_id: z.number().describe('Product parent ID.'),
  purchase_note: z.string().describe('Optional note to send the customer after purchase.'),
  categories: z.array(AdminProductCategorySchema).describe('List of categories.'),
  tags: z.array(AdminProductTagSchema).describe('List of tags.'),
  brands: z.array(AdminProductBrandSchema).optional().describe('List of brands.'), // Optional, depends on plugins
  images: z.array(AdminProductImage).describe('List of images.'),
  attributes: z.array(AdminProductAttributeSchema).describe('List of attributes.'),
  default_attributes: z.array(AdminProductDefaultAttributeSchema).describe('Defaults variation attributes.'),
  variations: z.array(z.number()).describe('List of variations IDs.'),
  grouped_products: z.array(z.number()).describe('List of grouped products ID.'),
