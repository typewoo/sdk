import { z } from 'zod';
import { ProductCollectionDataAttributeCountsResponseSchema } from './product.collection.data.attribute.counts.schema.js';
import { ProductCollectionDataPriceRangeResponseSchema } from './product.collection.data.price.range.schema.js';
import { ProductCollectionDataRatingCountsResponseSchema } from './product.collection.data.rating.counts.schema.js';
import { ProductCollectionDataTaxonomyCountsResponseSchema } from './product.collection.data.taxonomy.counts.schema.js';
