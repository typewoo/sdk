...
import { ProductPriceResponseSchema } from './product.price.schema.js';
import {
  ProductEmbeddedAttributeResponseSchema,
  ProductEmbeddedVariationResponseSchema,
} from './product.embedded.schema.js';
