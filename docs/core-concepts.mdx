...
Unlike the deprecated singleton pattern, you can create multiple SDK instances for different stores:
...
<Note>
  The legacy `Typewoo.init()` singleton is deprecated and will be removed in a
  future version.
</Note>
