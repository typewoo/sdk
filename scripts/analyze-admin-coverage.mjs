...
const sdkImplementations = {
  Products: [
    ...
    'AdminProductTagService',
    'AdminProductAttributeService',
    'AdminProductReviewService',
    'AdminShippingClassService',
  ],
  Orders: ['AdminOrderService'],
  Customers: ['AdminCustomerService'],
  Coupons: ['AdminCouponService'],
  Reports: ['AdminReportService'],
  Settings: ['AdminSettingService'],
  Shipping: ['AdminShippingZoneService'],
  Taxes: ['AdminTaxService', 'AdminTaxClassService'],
  Webhooks: ['AdminWebhookService'],
  System: ['AdminSystemStatusService'],
  Data: ['AdminDataService'],
  Payment: ['AdminPaymentGatewayService'],
  Refunds: ['AdminRefundService'],
  'Shipping Methods': ['AdminShippingMethodService'],
};
